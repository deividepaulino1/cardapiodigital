...
import 'package:cardapio/shared/widgets/topbar.dart';
...
class _CarrinhoPageState extends State<CarrinhoPage> {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const CustomTopBar(title: 'Meu Carrinho'),
        Padding(
                    ...
                    (index) => ListTile(
                      ...
                      trailing: Row(
                        ...
                        children: [
                          ...
                          Text('R\$ 10,00',
                              style: TextStyle(
                                  color: Colors.green, fontSize: 4.w)),
                        ],
                      ),
                    ),
                  ),
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        'Total:',
                        style: TextStyle(
                            color: DigiColors.secondary, fontSize: 6.w),
                      ),
                      Text(
                        'R\$ 10,00',
                        style: TextStyle(
        ...
        Expanded(
          child: Column(
            children: [
              Text('Forma de pagamento:', style: TextStyle(fontSize: 5.w)),
              SizedBox(height: 5.h),
              Row(
